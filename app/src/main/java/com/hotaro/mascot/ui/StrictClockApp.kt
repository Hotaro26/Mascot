...
import com.hotaro.mascot.StrictClockApplication
...
fun StrictClockApp(isWakeUp: Boolean = false, challengeType: String = "None", qrCodeData: String = "", qrCodeName: String = "", cameraObject: String = "", mathOperations: String = "", mathDifficulty: String = "") {
    ...
    var selectedAlarm by remember { mutableStateOf<com.hotaro.mascot.data.AlarmEntity?>(null) }
    ...
    DisposableEffect(lifecycleOwner) {
        val observer = androidx.lifecycle.LifecycleEventObserver { _, event ->
            if (event == androidx.lifecycle.Lifecycle.Event.ON_RESUME) {
                if (com.hotaro.mascot.service.AlarmService.isRinging) {
                    currentScreen = "WakeUp"
                    activeChallengeType = com.hotaro.mascot.service.AlarmService.currentChallengeType
                    activeQrCodeData = com.hotaro.mascot.service.AlarmService.currentQrCodeData
                    activeQrCodeName = com.hotaro.mascot.service.AlarmService.currentQrCodeName
                    activeCameraObject = com.hotaro.mascot.service.AlarmService.currentCameraObject
                    activeMathOperations = com.hotaro.mascot.service.AlarmService.currentMathOperations
                    activeMathDifficulty = com.hotaro.mascot.service.AlarmService.currentMathDifficulty
                    activeSoundUri = com.hotaro.mascot.service.AlarmService.currentSoundUri
                    activeVibrationEnabled = com.hotaro.mascot.service.AlarmService.currentVibrationEnabled
                }
            }
        }
            ...
            androidx.compose.animation.AnimatedContent(
                ...
                when (targetScreen) {
                    ...
                    "WakeUp" -> {
                        ...
                        val vibrationEnabled = if (com.hotaro.mascot.service.AlarmService.isRinging) activeVibrationEnabled else activity.intent.getBooleanExtra("VIBRATION_ENABLED", true)
                        ...
                        WakeUpScreen(
                            ...
                            onStopAlarm = {
                                val serviceIntent = android.content.Intent(context, com.hotaro.mascot.service.AlarmService::class.java)
                                context.stopService(serviceIntent)
                                
                                val activeAlarmId = if (com.hotaro.mascot.service.AlarmService.isRinging) com.hotaro.mascot.service.AlarmService.currentAlarmId else activity.intent.getIntExtra("ALARM_ID", -1)
                                if (activeAlarmId != -1) {
                                    Thread {
                                        kotlinx.coroutines.runBlocking {
                                            val repo = com.hotaro.mascot.data.AlarmRepository(com.hotaro.mascot.data.AppDatabase.getDatabase(context).alarmDao())
                            ...
                            onSnoozeAlarm = {
                                ...
                                val alarmId = if (com.hotaro.mascot.service.AlarmService.isRinging) com.hotaro.mascot.service.AlarmService.currentAlarmId else activity.intent.getIntExtra("ALARM_ID", -1)
                                val intent = android.content.Intent(context, com.hotaro.mascot.service.AlarmReceiver::class.java).apply {
