...
import com.hotaro.mascot.ui.theme.ExpressiveSwitch
...
@Composable
fun ClockDashboard(viewModel: AlarmViewModel? = null, onNavigateToSetup: () -> Unit = {}, onEditAlarm: (com.hotaro.mascot.data.AlarmEntity) -> Unit = {}) {
    ...
    val alarms = remember(rawAlarms) {
        rawAlarms.sortedBy { alarm ->
            if (alarm.isActive) com.hotaro.mascot.utils.AlarmUtils.getNextTriggerTime(alarm) else Long.MAX_VALUE
        }
    }
    Scaffold(
                ...
                SwipeToDismissBox(
                    ...
                    AlarmCard(
                        ...
                        onToggle = { isChecked ->
                            ...
                            if (isChecked) {
                                val triggerTime = com.hotaro.mascot.utils.AlarmUtils.getNextTriggerTime(updatedAlarm)
                                val toastMsg = com.hotaro.mascot.utils.AlarmUtils.formatTimeUntil(triggerTime)
...
@Composable
fun SystemClockCard(nextAlarm: com.hotaro.mascot.data.AlarmEntity? = null) {
        ...
        if (nextAlarm != null) {
            ...
            Surface(
                ...
                modifier = Modifier.clickable {
                    val triggerTime = com.hotaro.mascot.utils.AlarmUtils.getNextTriggerTime(nextAlarm)
